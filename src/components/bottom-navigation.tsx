...
export function BottomNavigation() {
	return (
		<nav className="fixed bottom-0 left-1/2 -translate-x-1/2 z-50 flex h-14 w-full max-w-screen-sm items-center justify-around bg-background shadow-[0_-2px_4px_rgba(0,0,0,0.1)]">
			<Link
				to="/"
